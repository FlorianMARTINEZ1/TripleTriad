...
function readData(sData) {
  ...
  var carte1 = new Card(cartes[tabId[0]]['nomCarte'], cartes[tabId[0]]['valN'], cartes[tabId[0]]['valS'],
    cartes[tabId[0]]['valO'], cartes[tabId[0]]['valE'], "bleue"); //  => créer une carte
  var carte2 = new Card(cartes[tabId[1]]['nomCarte'], cartes[tabId[1]]['valN'], cartes[tabId[1]]['valS'],
    cartes[tabId[1]]['valO'], cartes[tabId[1]]['valE'], "bleue"); //  => créer une carte
  var carte3 = new Card(cartes[tabId[2]]['nomCarte'], cartes[tabId[2]]['valN'], cartes[tabId[2]]['valS'],
    cartes[tabId[2]]['valO'], cartes[tabId[2]]['valE'], "bleue"); //  => créer une carte
  var carte4 = new Card(cartes[tabId[3]]['nomCarte'], cartes[tabId[3]]['valN'], cartes[tabId[3]]['valS'],
    cartes[tabId[3]]['valO'], cartes[tabId[3]]['valE'], "bleue"); //  => créer une carte
  var carte5 = new Card(cartes[tabId[4]]['nomCarte'], cartes[tabId[4]]['valN'], cartes[tabId[4]]['valS'],
    cartes[tabId[4]]['valO'], cartes[tabId[4]]['valE'], "bleue"); //  => créer une carte
  var carte6 = new Card(cartes[tabId[5]]['nomCarte'], cartes[tabId[5]]['valN'], cartes[tabId[5]]['valS'],
    cartes[tabId[5]]['valO'], cartes[tabId[5]]['valE'], "rouge"); //  => créer une carte
  var carte7 = new Card(cartes[tabId[6]]['nomCarte'], cartes[tabId[6]]['valN'], cartes[tabId[6]]['valS'],
    cartes[tabId[6]]['valO'], cartes[tabId[6]]['valE'], "rouge"); //  => créer une carte
  var carte8 = new Card(cartes[tabId[7]]['nomCarte'], cartes[tabId[7]]['valN'], cartes[tabId[7]]['valS'],
    cartes[tabId[7]]['valO'], cartes[tabId[7]]['valE'], "rouge"); //  => créer une carte
  var carte9 = new Card(cartes[tabId[8]]['nomCarte'], cartes[tabId[8]]['valN'], cartes[tabId[8]]['valS'],
    cartes[tabId[8]]['valO'], cartes[tabId[8]]['valE'], "rouge"); //  => créer une carte
  var carte10 = new Card(cartes[tabId[9]]['nomCarte'], cartes[tabId[9]]['valN'], cartes[tabId[9]]['valS'],
